...
#[cfg(test)]
mod tests {
    use fibonacci_math::golden_constants;
    use fibonacci_math::golden_kalman;
    use fibonacci_math::fibonacci_heap;
    use fibonacci_math::logarithmic_spiral;
    ...
    fn test_golden_kalman_convergence() {
        ...
        let gain = golden_kalman::golden_kalman_gain(1.0, 1.0, 100);
    ...
    fn test_logarithmic_spiral() {
        ...
        let spiral = logarithmic_spiral::LogarithmicSpiral::new(1.0, 0.5);
