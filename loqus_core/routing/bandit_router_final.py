...
class ModelArm:
    ...
    accuracy: float
    cost: float
    total_latency: float = 0.0  # Added as per requirements
    count: int = 0
...
class BanditRouter:
    ...
    def update_performance(self, arm_name: str, reward: float, latency: float):
        ...
        arm.total_latency += latency  # Added as per requirements
        self.total_pulls += 1
    ...
    def get_all_stats(self) -> dict:
        ...
        for arm_name, arm in self.arms.items():
            stats[arm_name] = {
                ...
                "total_latency": arm.total_latency  # Added as per requirements
            }
        return stats