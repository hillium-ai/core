...
class CompressedContext:
    ...
    data: str                       # Compressed text representation (was summary)
    ...
    metadata: Dict[str, Any] = None # Metadata about compression
    checksum: str = ""              # Integrity checksum (optional for MVP)
...
class MemoryCompressor(ABC):
    ...
    def decompress(self, compressed: CompressedContext) -> List[Message]:
        ...
        Returns:
            List of Message objects (may be reconstructed/summarized)
        """
        pass
...
class NoOpCompressor(MemoryCompressor):
    ...
    This is the default for MVP. It ensures the compression hooks
    ...
    def compress(self, context: List[Message]) -> CompressedContext:
        ...
        # Concatenate all content as "summary/data"
